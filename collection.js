...
const collection = [
    {//Part Murdered: Soul Suspect
        ...
        year: '2014',
        category: ['Investigation', 'Stealth'],
    ...
    {//Part The First Tree
        ...
        year: '2017',
        category: ['Exploration', 'Storytelling'],
...
for (let element of collection){
    ...
    newTag.className = 'has-text-weight-bold tag is-warning';
    ...
    newDevPub.textContent = (
        newSpanDev.textContent + 
        element.developer + ' ; ' +
        newSpanPub.textContent + 
        element.publisher);
